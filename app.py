...
def create_app():
    ...
    # external link to be used when accesseing from outside of a render instance i.e. localhost
    # 'postgresql://bizbooker_0hhh_user:UdqaHQxuyhCKvn7rI74sjeXMVE0BMKDR@dpg-cm7m1q6n7f5s73cdn210-a.oregon-postgres.render.com/bizbooker_0hhh'
